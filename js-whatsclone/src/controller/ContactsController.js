...
export class ContactsController extends ClassEvent {
    ...
    /** Método para abrir o modal da lista de contatos */
    open() {
                    ...
                    <div class="JSbIY">
                        <div tabindex="-1">
                            <div class="_2EXPL aZ91u">
                                ...
                                <div class="_3j7s9">
                                    <div class="_2FBdJ">
                                        <div class="_25Ooe"><span dir="auto" class="_1wjpf contact-name">${contact.name}</span></div>
                                    </div>
                                    <div class="_1AwDx">
                                        <div class="_itDl"></div>
    ...
    /** Método para fechar o modal da lista de contatos */
    close() {
        this._modal.hide();
    }
}